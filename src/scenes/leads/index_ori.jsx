            ...
            >
              ...
              return(
                ...
                <Form>
                    ...
                    <Grid container spacing={1}>
                      ...
                      <label htmlFor="first_name">First Name</label>
                        <Field
                          ...
                          />
                        {errors.first_name && touched.first_name ?(<p style={errorStyles}>{errors.first_name}</p> ): null}
                  ...
                  >
                    <Typography variant="h4" sx={{ display: "flex", justifyContent: "center", mt: 3, mb: 3}}>Customer Credentials</Typography>
                    ...
                    <Grid container spacing={1}>
                      ...
                      <label htmlFor="email">Email</label>
                        <Field
                          ...
                          onChange={handleChange}
                        />
                        {errors.email && touched.email && <p style={errorStyles}>{errors.email}</p>}
                      </Grid>
                      <Grid item xs={12} md={4} style={{ textAlign: "center" }}>
                      <label htmlFor="password">Password</label>
                        <Field
                          ...
                          onChange={handleChange}
                        />
                        {errors.password && touched.password  && <p style={errorStyles}>{errors.password}</p>}
                      </Grid>
                      <Grid item xs={12} md={4} style={{ textAlign: "center" }}>
                      <label htmlFor="confirmPassword">Confirm Password</label>
                        <Field
                          ...
                          onChange={handleChange}
                        />
                        {errors.confirmPassword && touched.confirmPassword  &&  <p style={errorStyles}>{errors.confirmPassword}</p>}
                      </Grid>
                    </Grid>
                  </Box>
