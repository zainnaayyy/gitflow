...
import { CallsItemsDialog } from "../../../components/asterisk/calls/CallsItemsDialog";
...
const Calls = () => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useGetCallsActivityQuery({ page, pageSize, search: searchKey });
  ...
  const FirstBridgeMember = (itemId) => {
    ...
    if (isSuccess) {
      ...
      return channel_item[0]['extension']
    }
  }
