...
const CaresourceDoughnuts2 = () => {
  ...
  if (isSuccess) {
    data_key_root = Object.keys(caresource["product"]);
    data_value_root = Object.values(caresource["product"]);
  }
...
export default CaresourceDoughnuts2;
