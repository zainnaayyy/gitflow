...
const BridgeMonitorStackTooltipChannels = ({ bridged_ext, users, bridge, colors }) => {
  // const bridgedUser = users.find((user) => user["extension"] === bridged_ext); delete

  console.log('BridgeMonitorStackTooltipChannels [[', bridged_ext, users, bridge)
...
export default BridgeMonitorStackTooltipChannels;
